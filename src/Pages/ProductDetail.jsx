...
export default function ProductDetail() {
  ...
  const handleOrder = () => {
    const message = `I want to order this: ${product.name}`;
      ...
      <div className=" px-4 sm:px-6 pb-16">
        <div className="flex flex-col md:flex-row gap-8 lg:gap-16">
          ...
          <div className="md:w-80 lg:w-96 flex flex-col">
            {/* Category badge */}
            <span className="inline-block w-fit px-3 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-600 mb-3">
              {product.category}
            </span>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">
                ✦ Fast delivery in Birgunj & nearby areas
              </p>
              <p className="text-xs text-gray-500">✦ Bulk orders available</p>
            </div>
          </div>
        </div>
      </div>
